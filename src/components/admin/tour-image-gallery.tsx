    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
      {images.map((image) => (
        ...
        >
          ...
          <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 max-md:opacity-100 transition-opacity flex items-center justify-center gap-2">
            {loadingId === image.id ? (
